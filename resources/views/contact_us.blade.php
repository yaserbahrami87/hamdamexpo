@component('master.index2')
    ...
    <div class="col-12 text-center text-dark mb-3">
        <img src="/images/{{$settings->where('setting','logo')->first()->value}}" width="170px" class="mb-3" />
        <h3>راه های ارتباطی:</h3>
        <p class="text-dark">{{$settings->where('setting','address')->first()->value}}</p>
    ...
    <div class="col-md-6 mx-auto bg-transparent mb-5 p-3" >
