    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.festival.update',['festival'=>$festival])}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="festival">عنوان جشنواره</span>
                                    </div>
                                    <input type="text" class="form-control"  aria-describedby="festival_fa" name="festival" value="{{old('festival',$festival->festival)}}" />
                                </div>
                                <div class="input-group mb-3">
                                    <label for="call_fa">متن فراخوان :</label>
                                    <textarea id="call_fa" name="description">{{old('description',$festival->description)}}</textarea>
                                </div>
